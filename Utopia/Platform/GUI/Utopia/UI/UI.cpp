...
namespace Utopia::UI {
	...
	void DrawButtonImage(const std::shared_ptr<Utopia::Image>& imageNormal, const std::shared_ptr<Utopia::Image>& imageHovered, const std::shared_ptr<Utopia::Image>& imagePressed,
		...
		ImVec2 rectMin, ImVec2 rectMax)
	{
		...
		{
			drawList->AddImage(
				(ImTextureID)(uintptr_t)(imagePressed->GetDescriptorSet()),
				rectMin, rectMax, ImVec2(0, 0), ImVec2(1, 1), tintPressed
			);
		}
		else if (ImGui::IsItemHovered())
		{
			drawList->AddImage(
				(ImTextureID)(uintptr_t)(imageHovered->GetDescriptorSet()),
		...
		{
			drawList->AddImage(
				(ImTextureID)(uintptr_t)(imageNormal->GetDescriptorSet()),
	...
	void DrawButtonImage(const std::shared_ptr<Utopia::Image>& image,
		ImU32 tintNormal, ImU32 tintHovered, ImU32 tintPressed,
		ImVec2 rectMin, ImVec2 rectMax)
	{
